...
[![GoDoc](https://godoc.org/github.com/petelin/calc?status.svg)](https://godoc.org/github.com/petelin/calc) [![Build Status](https://travis-ci.org/petelin/calc.svg?branch=master)](https://travis-ci.org/petelin/calc)
...
```
go get github.com/petelin/calc
```
